...
menu:    DB 0Dh,0Ah,"1- Make an order",0Dh,0Ah
         DB "2- Display the price",0Dh,0Ah 
...
flower_info:   
         DB 0Dh,0Ah,0Dh,0Ah,"1- ALSTROMERIA     10 SR",0Dh,0Ah
         DB "2- ASTER          6  SR",0Dh,0Ah
         DB "3- BALLOON FLOWER 7  SR",0Dh,0Ah
         DB "4- BROWALIA       4  SR",0Dh,0Ah, '$'
...
;===== Make an order =====
FIRST_CHOICE:
      ; Code to display the flower_info message
      mov dx, offset flower_info
      mov ah, 9
      int 21h
...
SECOND_CHOICE:
    ...
    finish:
	  cmp flower_price, 150
	  jle print
	  
	  ; price are more than 150 (discount 10%)
	  mov ax, flower_price
	  mov bl,10
	  div bl
	  mov ah, 0
